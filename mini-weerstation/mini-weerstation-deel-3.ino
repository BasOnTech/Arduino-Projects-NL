...
static const int buttonPin = 8;         // drukknop pin
int buttonState = LOW;                  // staat van de drukknop
...
long previousMillisButton = 0;          // Tijdstip van laatste uitlezing staat drukknop
